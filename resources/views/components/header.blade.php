<header>
    <nav class="navbar navbar-expand-md navbar-light shadow-sm samuraimart-header-container h-auto">
        <div class="container">
            <a class="navbar-brand logo-sp" href="{{ url('/') }}">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto user-sp">
                    @guest
                    ...
                    @else
                        ...
                        <li class="nav-item me-4">
                            <a class="nav-link" href="{{ route('mypage.favorite') }}">
                                <i class="far fa-heart"></i><span class="user-menu-sp">お気に入り</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('carts.index') }}">
                                <i class="fas fa-shopping-cart"></i><span class="user-menu-sp">カート</span>
                            </a>
                        </li>
                    @endguest
                </ul>
